<template>
  <a-card class="mb-4">
    <SubTitle title="今日热搜" icon="quote" />
    <ul>
        ...
        <li
          ...
          <div class="flex-shrink-0 mr-2">
            <div class="rounded-full ring-gray-100 overflow-hidden shaodw-lg w-9">
              ...
              <template v-else>
                <img class="avatar-img" :src="defaultSrc" alt="" />
              </template>
            </div>
          </div>
...
export default defineComponent({
  ...
  setup() {
    ...
    return {
      ...
      defaultSrc: 'https://static.linhaojun.top/aurora/config/0af1901da1e64dfb99bb61db21e716c4.jpeg',
      t
    }
  }
})
